...
import { TheoOAuthProgress } from './TheoOAuthProgress.js';
import { DeviceAuthorizationInfo } from '../hooks/useTheoAuth.js';
...
describe('TheoOAuthProgress', () => {
  ...
  describe('Loading state (no deviceAuth)', () => {
    it('should render loading state when deviceAuth is not provided', () => {
      ...
      expect(output).toContain('Waiting for Theo OAuth authentication...');
    ...
    it('should render loading state with gray border', () => {
      ...
      expect(output).not.toContain('Theo OAuth Authentication');
  ...
  describe('Timer functionality', () => {
    ...
    it('should use default 300 second timeout when deviceAuth is null', () => {
      const { lastFrame } = render(
        <TheoOAuthProgress onTimeout={mockOnTimeout} onCancel={mockOnCancel} />,
      );
  ...
  describe('Props changes', () => {
    ...
    it('should reset to loading state when deviceAuth becomes null', () => {
      ...
      expect(lastFrame()).toContain('Waiting for Theo OAuth authentication...');
  ...
  describe('Timeout state', () => {
    it('should render timeout state when authStatus is timeout', () => {
      ...
      const output = lastFrame();
      expect(output).toContain('Theo OAuth Authentication Timeout');
