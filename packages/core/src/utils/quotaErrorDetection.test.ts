...
describe('quotaErrorDetection', () => {
  describe('isTheoQuotaExceededError', () => {
    ...
    it('should not detect throttling errors as quota exceeded', () => {
      ...
      expect(isTheoQuotaExceededError(error)).toBe(false);
    });
  ...
  describe('isTheoThrottlingError', () => {
    ...
    it('should not detect throttling without 429 status in structured error', () => {
      ...
      expect(isTheoThrottlingError(error)).toBe(false);
    });
