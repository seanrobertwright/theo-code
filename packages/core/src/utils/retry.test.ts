...
describe('retryWithBackoff', () => {
  ...
  describe('Theo OAuth 429 error handling', () => {
    it('should retry for Theo OAuth 429 errors that are throttling-related', async () => {
    ...
    it('should throw immediately for Theo OAuth with insufficient_quota message', async () => {
      ...
      await expect(promise).rejects.toThrow(/Theo API quota exceeded/);

      // Should be called only once (no retries)
      expect(fn).toHaveBeenCalledTimes(1);
    });

    it('should throw immediately for Theo OAuth with free allocated quota exceeded message', async () => {
    ...
    it('should retry for Theo OAuth with throttling message', async () => {
    ...
    it('should retry for Theo OAuth with throttling error', async () => {
    ...
    it('should throw immediately for Theo OAuth with quota message', async () => {
    ...
    it('should retry normal errors for Theo OAuth (not quota-related)', async () => {
